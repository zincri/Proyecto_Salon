    ...
    <div class="container" >
                      ...
                      <ul class="slides">
                        <li data-thumb="images/j_img9.jpg">
                            <div class="thumb-image"> <img src="images/j_img9.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="images/j_img9.2.jpg">
                             <div class="thumb-image"> <img src="images/j_img9.2.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="images/j_img9.3.jpg">
                           <div class="thumb-image"> <img src="images/j_img9.3.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li> 
                         <li data-thumb="images/j_img9.4.jpg">
                           <div class="thumb-image"> <img src="images/j_img9.4.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                      </ul>
                </div>
                    <!-- FlexSlider -->
