...
<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/j_img1.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-12 col-md-offset-0">
					<ul class="timeline animate-box">
						...
						<li class="animate-box">
							...
							<div class="timeline-panel">
								...
								<div class="timeline-body">
									<p>Gracias por el apoyo y la dedicación a su trabajo. Todo quedó excelente. Muchas gracias.</p>
								</div>
							</div>
                        </li>
                    </li>
                    <li class="timeline-inverted animate-box">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timelines">
                                <p>Les agradecemos de todo corazón por tanto. Fueron un apoyo incondicional para nosotros, gracias por hacer de este momento algo inolvidable.</p>
                            </div>
                        </div>
                    </li>
                    <li class="animate-box">
                        <div class="timeline-badge" style="background-color:whitesmoke;">
                        <p><a href="{{ url ('login') }}" class="btn btn-default btn-lg">Agenda tu evento</a></p>
                        </div>
                    </li>
