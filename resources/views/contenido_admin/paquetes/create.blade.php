        ...
        <div class="mb-middle">
            <div class="mb-content">
                ...
                <div class="panel panel-default">
                                ...
                                <div class="form-group {{$errors->has('activo') ? 'has-error':''}} horizontal-checkbox">
                                    <label class="col-md-3 col-xs-12 control-label">Desactivado</label>
                                    <div class="col-md-6 col-xs-12">
                                        <input  name="activo" type="checkbox" value="0">
                                    </div>
                                    {!! $errors->first('activo','<span class="help-block">:message</span>')!!}
                                </div>
                                <div class="mb-footer">
